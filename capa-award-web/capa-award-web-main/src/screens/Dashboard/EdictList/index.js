    ...
    const columns = user?.isAdmin ?  [
        ...
        { 
            ...
            renderCell: ({ row }) => !row?.id ? null : <>
                <ContentTableAction>
                    <Button secondary link nospace onClick={() => navigate(`activities/list/article/${ row.id }/edit`)}>
                        Configurações
                    </Button>
                </ContentTableAction>
            </>  
        ...
        { 
            ...
            renderCell: ({ row }) => !row?.id ? null : <>
                <ContentTableAction>
                    <Button secondary link nospace onClick={() => navigate(`activities/show/article/${ row.id }`)}>
                        Ver artigo
                    </Button>
                </ContentTableAction>
            </>  
